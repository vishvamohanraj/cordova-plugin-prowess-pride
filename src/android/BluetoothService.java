...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(ProwessPrideBluetoothPrinter.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
...
//        }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        Message msg = mHandler.obtainMessage(ProwessPrideBluetoothPrinter.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(ProwessPrideBluetoothPrinter.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(ProwessPrideBluetoothPrinter.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(ProwessPrideBluetoothPrinter.TOAST, "Unable to connect to device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(ProwessPrideBluetoothPrinter.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(ProwessPrideBluetoothPrinter.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(ProwessPrideBluetoothPrinter.MESSAGE_READ, data).sendToTarget();
                    ...
                    if (bytes > 0) {
                        ...
                        mHandler.obtainMessage(ProwessPrideBluetoothPrinter.MESSAGE_READ_RAW, rawdata).sendToTarget();
                    }
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(ProwessPrideBluetoothPrinter.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
